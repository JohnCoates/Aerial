...
- Black screen / cannot stream: If you run a reverse firewall, such as Little Snitch or Hands Off!, be sure the application 'ScreenSaverEngine.app' is not being blocked access to *.phobos.apple.com and *.phobos.apple.com.edgesuite.net.
- Black preview / cannot cache: If you run a reverse firewall, such as Little Snitch or Hands Off!, be sure the application 'System Preferences.app' is not being blocked access to *.phobos.apple.com and *.phobos.apple.com.edgesuite.net.
