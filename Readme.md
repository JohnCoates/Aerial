...
* If you installed Aerial using Brew Cask, then the enter the following command in a Terminal window that should remove the Brew Cask installed version: `brew cask uninstall aerial`.
...
* **Brightness control:** Aerial can progressively dim the brightness of your screen before your Mac goes to sleep. You can even enable this feature only at night, or only on battery if you prefer.
